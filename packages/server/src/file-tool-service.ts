import { fileToolRequiresApproval, parseFileToolInvocation } from "@fosil/contracts";
...
export class FileToolService extends ToolService {
  ...
  protected override requiresApproval(name: string) { return fileToolRequiresApproval(name); }
}
