...
The current implementation provides TypeScript contracts, execution-state reduction, transactional storage with command acceptance, startup recovery, paged history, and a browser contract probe. It does not yet run coding tasks. See the [architecture reference](docs/architecture.md) for implemented boundaries.
