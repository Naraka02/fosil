...
| Understand and verify the execution loop | [Agent loop](agent-loop.md), then [Agent Loop acceptance](agent-loop-acceptance.md) |
| Configure the product model and inspect vendor translation | [DeepSeek Responses provider](deepseek-provider.md) |
